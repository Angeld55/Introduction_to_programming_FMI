...
**Задача 3:**
Да се напише функция, която приема символен низ и превръща всички негови главни букви в малки и всички малки в главни, а всяка цифра превръща в *.
...
**Задача 6:** Да се напише функция, която приема стринг с произволна дължина от цифри, и стринг **result**. Функцията да обработва **result** така, че да представлява стринг, в който е съставен от цифрите на подадения стринг, които се намират на четни позиции. (За улеснение индекасцията започва от 0).
...
**Задача 7:** Да се напише функция, която приема 2 стринга и стринг **result**. Функцията да обработва **result** така, че да представлява стринг, който съдържа само тези елементи, които се съдържат и в двата стринга.
