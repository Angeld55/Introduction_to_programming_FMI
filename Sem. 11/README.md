...
**П.с:** Това беше моя курсова работа в първи курс. Кодът съм го загубил, но съм ви качил конзолното приложение **(homework_example/MineSweeper.zip)**.
Можете да го свалите и да го ползвате като ориентир. В моята програма има и един бъг (ако я разцъкате, ще го забележите), който не мога да оправя (понеже нямам кода вече). 
