...
unsigned foundFirstOccurenceIndex(const int arr[], size_t size, unsigned beginIndex, int element)
{
...
bool canFirstBeFromSecondByDeletion(const int arr1[], size_t size1, const int arr2[], size_t size2)
{
	...
	{
		unsigned firstIndexInFirstArr = foundFirstOccurenceIndex(arr1, size1, arr1Iter, arr2[arr2iter]);
