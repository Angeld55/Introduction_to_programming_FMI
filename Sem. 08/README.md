 ...
 - **Задача 1 (малък проект)  :** Реализирайте играта **"Бикове и крави"**. Програмата ще генерира число и потребителят ще трябва да позне числото.
...
Примерна имплементация на:
 ...
 - търсене в текст
 - броене на конкретен символ в текст
