...
**Задача 3.**Задайте четирицифрено число за стойност на променлива. Да се отпечатат цифрите му. След това отпечатайте средните две цифри, както и сбора на първата и последната.
