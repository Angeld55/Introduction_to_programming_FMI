...
**Задача 4:**  Въвежа се малка буква от английската азбука. Да се отпечата номера на буквата в азбуката.
...
**Задача 6:**  Въвежа се четирицефрено цяло число. Да се отпечат цифрите му.
...
**Задача 13:** От конзолата се въвеждат 6 символа. Да се провери дали сумата от ASCII кодовете на тези символи се дели на 3. Ако се дели на 3 да се изведе на конзолата 1, ако не -> 0. 
