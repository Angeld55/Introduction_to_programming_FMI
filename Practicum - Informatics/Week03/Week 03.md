# УП - Практикум 22.10.2024 Седмица 3 
## Задачи
...
**Задача 4**  Потребител въвежда променлива N. Ако N е четно, то N се замества с N/2. Ако N e нечетно, то N се замества с 3*N+1. Преключваме, когато N=1.
вход 6 -> 3 10 5 16 8 4 2 1
